...
Route::group(['namespace'=>'Api\Customer'],function(){
	...
	Route::post('/sociallogin','CustomerController@socialLogin');
...
Route::group(['namespace'=>'Api\frontend'],function(){
	...
	Route::get('/allcity','FrontendController@allCities');
	Route::get('/allcitystores/{id}','FrontendController@allCitiesStores');
	Route::get('/allstorecategories/{slug}','FrontendController@allStoreCategories');
	Route::get('/categoryproducts/{slug}/{store_id}','FrontendController@categoryProducts');
	...
	Route::post('/stripecreatepayment','FrontendController@stripeCreatePayment');
});
