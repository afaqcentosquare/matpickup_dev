...
Route::group(['as' =>'store.','prefix'=>'store','namespace'=>'Amcoders\Plugin\shop\http\controllers','middleware'=>['web','auth','store','verified','approval']],function(){
	...
	Route::get('importexcelfile', 'ShopController@importExcelView')->name('import.excel');
	Route::post('importexceldata', 'ShopController@importExcelData')->name('import.excel.data');
