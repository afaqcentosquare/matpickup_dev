...
class ShopController extends controller
{
    ...
    public function create()
    {
        ...
        // $info=Category::where('user_id',Auth::id())->get();
               ...
               if($data->count() > 0)
               {
                foreach($data->toArray() as $key => $value)
                {
                 foreach($value as $row)
                 {
                     ...
                     $row[2] !="Price" && $row[2] != null && $row[3] != "Jfr-pris" && $row[3] != null &&
                    ...
                    $categories = Category::where('user_id',Auth::id())->first();
                    $cat= new PostCategory;
                    $cat->term_id=$post->id;
