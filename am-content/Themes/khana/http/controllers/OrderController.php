...
class OrderController extends controller
{
    public function store(Request $request)
    {
        ...
        if (isset($request->shipping)) {
            if ($request->shipping != "undefined") {
                // $shipping=  str_replace(",","",number_format($request->shipping,2));
                $shipping=  str_replace(",","",number_format(80.00,2));
            }
            else{
                // $shipping = 130.00;
                $shipping = 80.00;
        ...
        if (!empty($request->shipping)) {
            ...
            // $order->shipping = 130.00;
            $order->shipping = 80.00;
        }
        $order->shipping = 80.00;
        ...
        //    $data['amount']=$replace_total + 130.00;
        $data['amount']=$replace_total + 80.00;
    ...
    public function stripe_view()
    {
      ...
      return view('theme::frontend.stripe');
    }
