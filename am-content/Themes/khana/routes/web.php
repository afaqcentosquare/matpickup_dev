...
Route::group(['namespace'=>'Amcoders\Theme\khana\http\controllers','middleware'=>'web'],function(){
	...
	/**
	 * New Front Routes Start
	 */


	Route::get('home','WelcomeController@home')->name('home');
	Route::get('product/{slug}','WelcomeController@singleProduct')->name('single.product');
	Route::get('user/store/product/{slug?}','WelcomeController@storeProducts')->name('user.store.products');
	Route::get('user/store/category/{slug?}','WelcomeController@categoryProducts')->name('user.category.products');
	Route::get('stores','WelcomeController@allStores')->name('user.all.stores');
	// Route::get('cart','WelcomeController@cart')->name('user.cart');
	Route::get('cart','CheckoutController@index')->name('user.cart');
	Route::get('test','WelcomeController@test')->name('test');
	Route::get('search/product','WelcomeController@searchProduct')->name('search.product');
	Route::get('autocomplete','WelcomeController@autocomplete')->name('autocomplete');
	Route::get('user/login/bankid','WelcomeController@bankIdLoginForm')->name('user.login.bankid.form');
	Route::post('user/bankid','WelcomeController@bankIdLogin')->name('user.login.bankid');
	Route::post('user/bankid/collectstatus','WelcomeController@bankIdLoginCollectStatus')->name('user.login.bankid.collectstatus');
	 /**
	...
	Route::post('/searchbycity','AreaController@searchByCity')->name('resturents.search.city');
...
Route::group(['as' =>'author.','prefix'=>'author','namespace'=>'Amcoders\Theme\khana\http\controllers\Author','middleware'=>['web','auth']],function(){
	...
	Route::get('order/{id}','OrderController@details')->name('order.details');
	Route::post('address/store','DashboardController@storeAddress')->name('store.address');
